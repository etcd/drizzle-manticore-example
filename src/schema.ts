/**
 * Drizzle schema for an example `Posts` table. Running `npm run db:push` will push
 * the corresponding schema to the Manticore database:
 *
 *   CREATE TABLE Post(
 *     user string,
 *     txt text,
 ...
 * actual schema, and map to an equivalent drizzle schema in `schema.ts`.
 * 
 * The ideal way to handle this is to create a Drizzle table adapter for Manticore.
 * */
